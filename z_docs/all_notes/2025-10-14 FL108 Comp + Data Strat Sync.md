...
- Map capabilities for binder design
	- epitope specific design
	- "accuracy"
	- can PI help? 
	- If we have ab and need recoding? 
	- what do we have well established and hit rates? --> does PI have this?!? 

- TfR binder design
	- $35k (quote from PI)
	- Nate + Andrew (Aris was running the program)

- Michael Kemp
	- protein scientist
	- more of a rationale design (structural biology background)


### ✅ **Action Items** 
- [x] ask Andrew Ban about capabilities for binder design 📅 2025-10-14 ✅ 2025-10-14
