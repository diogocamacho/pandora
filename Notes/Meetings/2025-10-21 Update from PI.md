...
- **Dataset Construction**: A training dataset was built from the shared [[Abiologics Home|Abiologics]] data, consisting of 10 Å neighborhoods centered around each target amino acid, with the central residue masked.
