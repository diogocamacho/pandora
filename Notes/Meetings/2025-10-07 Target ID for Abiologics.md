...
Will have to show Chiara some of the work that I have been doing with the target ID piece. I have some code written (check Cursor), with diseases of interest to [[Abiologics Home|Abiologics]]. Namely:
