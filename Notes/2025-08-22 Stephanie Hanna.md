...
- David’s lab
- Graduating soon
- Working on cyclic peptide design and mini binders
- Using Rosetta design, now focusing on MPNN and RFdiff
...
- Structure with AF2
- Use that -> RFDiff -> protein MPNN -> challenge with non-canonical amino acids -> complex prediction to see if it folds
...
- Mainly using AF and pLDDT -> to check if they form complex
- pLDDT may not translate into synthesis
...
- Can we crowdsource data to help with affinity prediction? 
- Not a good ML background
...
- using for enzyme design to model binding pocket
...
- Look at sequences (are they aggregating, are they not folding)
- Look at SASA score of binders
...
- CSV of sequences, length
- pLDDT (how likely is it to fold)
